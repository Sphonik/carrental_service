...
/**
 * Data Transfer Object representing a car with its details and availability.
 *
 ...
 * @param pricePerDay    rental price per day in the default currency
 * @param pickupLocation location where the car can be picked up
 * @param available      whether the car is currently available for booking
 */
